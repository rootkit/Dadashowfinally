...
//  iOS_Version_1.0
//
//  Created by liping on 2017/6/15.
...
CGFloat const JPVideoPlayerDemoNavAndStatusTotalHei = 0;
CGFloat const JPVideoPlayerDemoTabbarHei = 0;
...
//        self.playingCell.videoImv.alpha=1.0;
//        self.playingCell.backgroundColor=[UIColor colorWithHex:0x3f3f3f];
        // display status view.
...
//        bestCell.backgroundColor=[UIColor colorWithHex:0x3f3f3f];
//        self.playingCell.videoImv.alpha=0.3;
//        self.playingCell.backgroundColor=[UIColor colorWithHex:0x3f3f3f];
...
//        cell.videoImv.alpha=0.3;
//        cell.backgroundColor=[UIColor colorWithHex:0x3f3f3f];
...
//    finnalCell.videoImv.alpha=1.0;
//    finnalCell.backgroundColor=[UIColor colorWithHex:0x3f3f3f];
    return finnalCell;
}
