...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JPVideoPlayerDemoCell * cell = [[JPVideoPlayerDemoCell  alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:JPVideoPlayerDemoReuseID];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JPVideoPlayerPlayingStatus status = cell.videoImv.playingStatus;
    if (status == JPVideoPlayerPlayingStatusPlaying) {
        [ cell.videoImv jp_pause];
    }
    else{
        [ cell.videoImv jp_resume];
    }
