...
#import "RechargefailuViewController.h"

@interface RechargefailuViewController ()

@end

@implementation RechargefailuViewController
...
-(void)rechargeview{
    ...
    foximage.image=[UIImage imageNamed:@"no_recharge"];
    ...
    [pursebtn setBackgroundImage:[UIImage imageNamed:@"Tryagain_btn"] forState:UIControlStateNormal];
