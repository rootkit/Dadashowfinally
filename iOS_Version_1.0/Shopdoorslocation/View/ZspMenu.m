...
#define kTextSelectColor  [UIColor colorWithHex:0xff337e];
...
@property (nonatomic, strong) UILabel *leftline;  //选中左边红色线条
@property (nonatomic, strong) UILabel *rightLine;  //选中右边边红色线条
@property (nonatomic, copy) NSArray *titles;
@property (nonatomic, copy) NSArray *indicators;
@property (nonatomic, copy) NSArray *bgLayers;
@property(nonatomic,assign)NSInteger index;//选择哪行
@property(nonatomic,assign)NSInteger rihgtindex;//选择哪行
@end
...
- (void)setDataSource:(id<ZspMenuDataSource>)dataSource {
    ...
    for (int i = 0; i < _numberOfColumn; i++) {
        ...
        line.frame=CGRectMake(0, self.height-2,SCREEN_WIDTH/2  , 1);
        [self addSubview:line];
        _leftline=line;
        
        UILabel* rightline=[[UILabel alloc]init];
        rightline.backgroundColor=[UIColor clearColor];
        rightline.frame=CGRectMake(SCREEN_WIDTH/2, self.height-2,SCREEN_WIDTH/2  , 1);
...
//            }
//
            if (_currentSelectedColumn==1) {
                if (self.rihgtindex==indexPath.row) {
                    cell.imageView.image = [UIImage imageNamed:@"gouxuan"];
                }
            }
...
//        }
        ...
        if (_dataSourceFlag.titleForItemInRowAtIndexPath) {
            ...
            cell.backgroundColor=[UIColor colorWithHex:0xf7f2f2];
