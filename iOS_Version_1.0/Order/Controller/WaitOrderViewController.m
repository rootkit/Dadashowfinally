...
@interface WaitOrderViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
-(void)setordergoodsview{
    ...
    reasonlabel.text = @"收货信息已提交,请耐心等待";
    ...
    reasonimageview.image=[UIImage imageNamed:@"ico_to-send-the-goods"];
    ...
    [reasonimageview mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(@(-20*(kScreen_Height/667)));
    }];
    ...
    remindbtn.titleLabel.font=[UIFont systemFontOfSize:13*(kScreen_Height/667)];
    [remindbtn setTitle:@"提醒发货"forState:UIControlStateNormal];
    [remindbtn setTitleColor:[UIColor colorWithHex:0x353535] forState:UIControlStateNormal];
    remindbtn.layer.cornerRadius = 4*(kScreen_Height/667);
    remindbtn.layer.borderWidth = 0.4;
    remindbtn.layer.borderColor = [UIColor colorWithHex:0x333333].CGColor;
    remindbtn.layer.masksToBounds=YES;
    [remindbtn addTarget:self action:@selector(clickremin) forControlEvents:UIControlEventTouchUpInside];
    [extraview addSubview:remindbtn];
