...
@interface SuccessOrderViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
-(void)setordergoodsview{
    ...
    [statelabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(@(42*(kScreen_Height/667)));
        make.left.equalTo(@(36*(kScreen_Height/667)));
    }];
    
    UIImageView* reasonimageview=[[UIImageView alloc]init];
    reasonimageview.image=[UIImage imageNamed:@"ico_succend"];
    ...
    [reasonimageview mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(@(-38*(kScreen_Height/667)));
    }];
    /*物流信息提示**/
    ...
    UIButton * sellfinishbtn=[[UIButton alloc]init];
    sellfinishbtn.titleLabel.font=[UIFont systemFontOfSize:13*(kScreen_Height/667)];
    [sellfinishbtn setTitle:@"申请售后"forState:UIControlStateNormal];
    [sellfinishbtn setTitleColor:[UIColor colorWithHex:0x353535] forState:UIControlStateNormal];
    sellfinishbtn.layer.cornerRadius = 4*(kScreen_Height/667);
    sellfinishbtn.layer.borderWidth = 0.4;
    sellfinishbtn.layer.borderColor = [UIColor colorWithHex:0x333333].CGColor;
    sellfinishbtn.layer.masksToBounds=YES;
    [sellfinishbtn addTarget:self action:@selector(clicksellfinish) forControlEvents:UIControlEventTouchUpInside];
    [backview addSubview:sellfinishbtn];
    [sellfinishbtn mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    UIButton * evaluatelbtn=[[UIButton alloc]init];
    evaluatelbtn.titleLabel.font=[UIFont systemFontOfSize:13*(kScreen_Height/667)];
    [evaluatelbtn setTitle:@"评价"forState:UIControlStateNormal];
    [evaluatelbtn setTitleColor:[UIColor colorWithHex:0xfc5c98] forState:UIControlStateNormal];
    evaluatelbtn.layer.cornerRadius = 4*(kScreen_Height/667);
    evaluatelbtn.layer.borderWidth = 0.4;
    evaluatelbtn.layer.borderColor = [UIColor colorWithHex:0xfc5c98].CGColor;
    evaluatelbtn.layer.masksToBounds=YES;
    [evaluatelbtn addTarget:self action:@selector(clickevaluatel) forControlEvents:UIControlEventTouchUpInside];
    [extraview addSubview:evaluatelbtn];
    [evaluatelbtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(@(-11*(kScreen_Height/667)));
        make.right.equalTo(@(-12*(kScreen_Height/667)));
        make.width.equalTo(@(80*(kScreen_Height/667)));
        make.height.equalTo(@(26*(kScreen_Height/667)));
    ...
    [delegatebtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(@(-11*(kScreen_Height/667)));
        make.right.equalTo(evaluatelbtn.mas_left).equalTo(@(-10*(kScreen_Height/667)));
        make.width.equalTo(@(80*(kScreen_Height/667)));
        make.height.equalTo(@(26*(kScreen_Height/667)));
    }];
