...
@interface OrderGoodsViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
//    [self.view addSubview:collectheadview];
    ...
    reasonimageview.image=[UIImage imageNamed:@"ico_close"];
    ...
    [reasonimageview mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(@(-67*(kScreen_Height/667)));
    }];
...
//    /*第四个个分区 **/
    ...
    delegatebtn.layer.borderColor = [UIColor colorWithHex:0x3e3e3e].CGColor;
    delegatebtn.layer.masksToBounds=YES;
    [delegatebtn addTarget:self action:@selector(clickcancallorder) forControlEvents:UIControlEventTouchUpInside];
