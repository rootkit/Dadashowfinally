...
//        _contentTextView.textContainerInset     = UIEdgeInsetsMake(-5, -5, -5, -5);
        _contentTextView.textContainerInset     = UIEdgeInsetsMake(0, -5, 0, -5);
...
- (void)judge
{
    ...
    //文本内容
    if (!_textFont)  _textFont                   = [UIFont systemFontOfSize:13.f];
