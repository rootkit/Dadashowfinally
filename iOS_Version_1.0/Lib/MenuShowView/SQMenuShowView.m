...
#define itemHeigth     45*kScreen_Width/375  //每项高度
#define triangleWith   15*kScreen_Width/375  //三角形的高度
...
- (id)initWithFrame:(CGRect)frame items:(NSArray<NSString *> *)items showPoint:(CGPoint)showPoint{
    ...
    if (self) {
        ...
        newFrame.size.height = items.count *itemHeigth+triangleWith-5*kScreen_Width/375;
        self.frame = newFrame;
        self.alpha = 0;
...
- (UITableView *)myTabelView{
    ...
    _myTabelView.frame = (CGRect){0,triangleWith-5*kScreen_Width/375,self.frame.size.width,self.frame.size.height-(triangleWith-5*kScreen_Width/375)+8*kScreen_Width/375};
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SQMenuShowCell *cell = [[ SQMenuShowCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
...

{
    ...
    CGPoint leftPoint     = CGPointMake(self.showPoint.x - self.originalRect.origin.x-triangleWith/2, triangleWith-5*kScreen_Width/375);
    CGPoint rightPoint    = CGPointMake(self.showPoint.x - self.originalRect.origin.x+triangleWith/2, triangleWith-5*kScreen_Width/375);
