...
@interface HXVideoview ()<HXCollectionViewDataSource,HXCollectionViewDelegate,HXPhotoViewControllerDelegate,HXPhotoSubViewCellDelegate,UIActionSheetDelegate,HXCameraViewControllerDelegate,UIAlertViewDelegate>
...
- (HXPhotoModel *)addModel
{
    if (!_addModel) {
        ...
        _addModel.thumbPhoto = [UIImage imageNamed:@"ico_shiping"];
